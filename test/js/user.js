...
layui.define(['jquery', 'layer', 'table' , 'laypage' , 'form', 'laydate', 'upload'], function (exports) {
        ...
        [
            ...
            },
            {
                ...
                templet: function(d){
                    ...
                    return map[d.userrole] || d.userrole;
                },
                minWidth: 120,
            },
            {
    ...
    const EXPORT_URL = LAYER_IFRAME_URL + "/user" + "/exportUser";

    const EXCEL_URL = LAYER_IFRAME_URL + "/user" + "/excelUser";
